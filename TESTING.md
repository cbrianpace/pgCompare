...
Before submitting an enhancement or fix, run the tests outlined in this guide to reduce the risk of regressions. Include evidence in the pull request, such as unit test output and comparison summaries.
...
As part of the Data Validation Tool project (https://github.com/GoogleCloudPlatform/professional-services-data-validator), the Google Database Black Belt Team created a sample set of tables and data for testing data comparison tools. These tables are recommended, but not required, for pull request validation.
...
### Test 3: Compare All
    pgcompare compare --batch 0

### Test 4: Create Out of Sync and Compare
...
### Test 5: Check Out of Sync
    pgcompare check --batch 0

### Test 6: Test with Database Hash Disabled
Set `column-hash-method=hybrid` and rerun the comparison:
